...
from app.lib.biblioteca_spania import (
    descriere_tara,
    descriere_capitala,
    descriere_limbi,
    descriere_populatie
...
def test_functie_descriere_tara():
    expected_result = "Regatul Spaniei este o tara situata in sud-vestul Europei, in Peninsula Iberica. Este cunoscuta pentru cultura, turism, gastronomie si orase importante precum Madrid, Barcelona, Sevilla si Valencia."
...
def test_functie_populatie():
    expected_result = "aproximativ 48 de milioane de locuitori"
