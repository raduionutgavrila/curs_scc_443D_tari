import logging
from app.lib.biblioteca_namibia import descriere_tara, descriere_capitala, descriere_limbi, descriere_populatie
...
def test_functie_descriere_tara():
    expected_result = "Namibia este una dintre cele mai spectaculoase și sigure destinații din Africa, situată în partea de sud-vest a continentului, pe coasta Atlanticului. Este o țară a contrastelor extreme, unde deșertul întâlnește oceanul și unde peisajele par adesea de pe altă planetă."
...
def test_functie_populatie():
    expected_result = "2.7 milioane de locuitori"
...
def test_functie_limbi():
    expected_result = "Engleza, Germana, Afrikans"
