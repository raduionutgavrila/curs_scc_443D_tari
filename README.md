...
│   ├── germania_docker_build.png
│   ├── germania_jenkins_build_pass.png
│   ├── germania_jenkins_console_output.png
│   └── germania_pytest.png
├── static
│   └── steag_germania.png
├── tari.py
...
![Jenkins Build Pass](screenshots/germania_germania_jenkins_build_pass.png)

În Console Output se observă rularea pipeline-ului Jenkins și finalizarea cu succes.

![Jenkins Console Output](screenshots/germania_germania_jenkins_console_output.png)
...
![Docker Build](screenshots/germania_germania_docker_build.png)
